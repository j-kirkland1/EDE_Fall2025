...
```{r echo=FALSE, warning=FALSE, fig.align="left", fig.cap="2018 monthly Ozone levels", fig.height=4, fig.width=9}
# boxplots of the distribution of Ozone levels by month using, one for only records collected in 2018


ozonelevels2018 <- epa_data %>%
  filter(Year == 2018) %>%
  ggplot(aes(
...
print(ozonelevels2018)


```

```{r echo=FALSE, warning=FALSE, fig.align="left", fig.cap="2019 monthly Ozone levels", fig.height=4, fig.width=9}

# boxplots of the distribution of Ozone levels by month using, one for only records collected in 2019

ozonelevels2019 <- epa_data %>%
  filter(Year == 2019) %>%
  ggplot(aes(
    x = factor(Month, levels = 1:12, labels = month.abb),
    y = Ozone
...
[mylink] (https://github.com/j-kirkland1/EDE_Fall2025)

I did not use AI in this assignment- Julia Kirkland October 16, 2025.
