...
```{r echo=FALSE, warning=FALSE, fig.align="left", fig.cap="Ozone Levels by Month (2018)", fig.height=4, fig.width=9}
...
```{r echo=FALSE, warning=FALSE, fig.align="left", fig.cap="Ozone Levels by Month (2019)", fig.height=4, fig.width=9}
