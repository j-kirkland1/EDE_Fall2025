...
>Answer: Data exploration allows us to understand the structure, context, and quality of the dataset before we begin manipulating it and creating a finished product that someone can use to inform their decisions. Once we understand the short comings of the data, the context and the structure, we can make decisions about how to clean it and what we can discover from the information.
...
USGS.flow.data <- read.csv(
  file=here ('/home/guest/EDE_Fall2025/Data/Processed/USGS_Site02085000_Flow_Processed.csv'), 
...
> Answer: Bar plot is for categorical variables. A histogram is for continuous data. A frquency polygon is for continuous information. Box-and whisker plits give a five number summary that is efficient for continuous and categorical variables. Violin plot are like box and whisker, but they also show density of responses. It gives you more information about the distribution of the data. A scatterplot is benefitical to see how the data differs and where general trends happen.

## Ending discussion
What did you learn about the USGS discharge dataset today? What separate insights did the different graph types offer?
> Answer: Most of the height means were around 2.5. 


How can multiple options for data exploration inform our understanding of our data?

> Answer: All different graphs show all different statistics. They are all different ways of understanding and interpreting data.
...
> Answer: NOt too sure- maybe that the height stays consistant.
