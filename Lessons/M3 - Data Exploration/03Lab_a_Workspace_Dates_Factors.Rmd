...
# 2.Read in all CSV files starting with EPAair_O3inot a single data frame
folder <- here("Data", "Raw")
files <- dir(filefolder, pattern = "EPAair_O3*.*csv", full.names =TRUE)
files
...
#Summary - is it meaningful? no it is not
summary(sites$dow)
...
#Summary - is it meaningful? YES- extracting data and turning them into numbers through assignment can be more useful for analysis
summary(sites$dow)
...
Usgs_flow_data$<- factor (usgs_flow->)
