...
> Answer: notes about the package, errors or warnings or nothing!
...
#it says that it cannot open the file
...
> ANSWER: I can find this file in the metadata folder. This file is stored at the root of the data organizational structure. It gives important background information so that other collaborators can understand why the data is structured in a certain way and help contextualize the data.
...
> Answer: They were identified as "NA" values, or missing values.
