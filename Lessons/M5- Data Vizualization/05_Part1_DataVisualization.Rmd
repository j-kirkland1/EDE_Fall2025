...
Nutrientplot3 <-
  ...
  geom_boxplot(aes(color = nutrient)) # Why didn't we use "fill"? you are just changing the fill of the box plots and not anything else. when workign with box plots, use color. 
