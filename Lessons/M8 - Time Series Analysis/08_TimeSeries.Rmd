...
#Read Eno river data
EnoDischarge <- read.csv(here
                         ("Data", "Processed_KEY", "USGS_Site02085000_Flow_Processed.csv"),
  stringsAsFactors = TRUE
)
EnoDischarge$datetime <- as.Date(EnoDischarge$datetime, format = "%Y-%m-%d")

#Read wind speed data
wind_data <- read.csv (here
                      ("Data", "Raw", "Wind_Speed_PortArthurTX.csv"),
                      header=TRUE,
                      stringsAsFactors = TRUE)
...
Let's look at what the dataset contains for daily discharge.
...
> Answer: This is a negative linear trend. The wind speed has decreased over time.
