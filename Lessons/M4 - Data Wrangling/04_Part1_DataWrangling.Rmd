...
# I used this code because the 1999 did not have to have quotes because the class of the code is an integer
...
NTL.phys.data.Tuesdaylake90to99 <- filter(NTL.phys.data, 
    lakename == "Tuesday Lake", year4 > 1989 & year4 < 2000)
```
Question: Why don't we filter using row numbers?

> Answer: Because the colomn headers give us more relevant information. Row numbers do not have relevant information. 
...
#E East Long Lake  1998 0.5
#H Hummingbird Lake  2002 0.0
#H Hummingbird Lake 2002 0.0
...
Because it organizes our code and keeps our analysis clean and straight forward
