...
# I am using the dplyr filter because I am working with an integer

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
class(NTL.phys.data$year4) 

NTL.phys.data.tuesdaylake<- filter(NTL.phys.data, year4 %in% 1990:1999, lakename == "Tuesday Lake") 
...
> Answer: #this is because the colomns hold more relevant and important information.
